          ...
          <div className='flex flex-col gap-1'>
             ...
             <div className='flex items-center gap-2'>
                {product.colors.map(color => (
                  ...
                  <div key={color} className={`cursor-pointer border-1 ${productTypes.color === color ? "border-gray-400" : "border-gray-200"} rounded-full p-[1.2px]`} onClick={()=>handleProductType({type : "color" , value : color})}>
                    <div
